...
import SelectUserRolesRepartidores from "../../Elements/Compuestos/SelectUserRolesRepartidores.jsx";
...
export default function ({
  ...
  return (
    <Grid container spacing={2} sx={{ padding: "2%" }}>
      <Grid item xs={12}>
        <h2>{ isEdit ? "Editar Repartidor" :  "Ingreso Repartidor"} </h2>
      </Grid>
