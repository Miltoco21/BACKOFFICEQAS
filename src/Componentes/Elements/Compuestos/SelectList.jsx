...
const SelectList = ({
  ...
  styles = {},
  vars = null,
  optionValue = "id",    // Nueva prop
  optionLabel = "nombre" // Nueva prop
}) => {
  ...
  return (
    <>
      ...
      >
        ...
        {selectItems.map((item, ix) => {
          // Maneja tanto objetos como strings
          const value = typeof item === 'object' ? item[optionValue] : item;
          const label = typeof item === 'object' ? item[optionLabel] : item;
