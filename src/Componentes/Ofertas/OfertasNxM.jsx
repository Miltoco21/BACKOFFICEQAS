...
//     console.log(
//       `  Precios: ${productosSeleccionados
//         .map((p) => `$${p.precioVenta}`)
//         .join(", ")}`
//     );
...
//     const productoMenor = productosSeleccionados.find(
//       (p) => p.precioVenta === precioMenor
//     );
...
//       console.log(
//         `  Producto con 100% descuento: ${
//           oferta_ListaCanasta.find((p) => p.porcDescuento === 100)
//             ?.descripcionProducto
//         }`
//       );
//     }
...
//           <Typography variant="body2" gutterBottom>
//             • Unidades gratis (100% descuento):{" "}
//             <strong>{detalleCalculo.unidadesGratis}</strong>
//           </Typography>
...
//             </Typography>
//             <Box
//               sx={{ ml: 2, p: 1, backgroundColor: "#e3f2fd", borderRadius: 1 }}
//             >
//               <Typography variant="caption" display="block">
//                 - {detalleCalculo.paga} entrada(s) con cantidad: 1,
//                 porcDescuento: 0%
//               </Typography>
//               <Typography variant="caption" display="block">
//                 - {detalleCalculo.unidadesGratis} entrada(s) con cantidad: 1,
//                 porcDescuento: 100%
//               </Typography>
//               <Typography
//                 variant="caption"
...
//               <strong>${detalleCalculo.descuentoPorUnidad}</strong>
//             </Typography>
//             <Typography variant="body2">
//               • Total sin descuento:{" "}
//               <strong>${detalleCalculo.totalSinDescuento}</strong>
//             </Typography>
//             <Typography variant="body2">
//               • Total a pagar:{" "}
//               <strong>${detalleCalculo.totalConDescuento}</strong>
//             </Typography>
//             <Typography
//               variant="body2"
//               color="success.main"
...
//           >
//             oferta_Regla: cantidad = 1, valor = $
//             {detalleCalculo.descuentoPorUnidad}, aplicacion = "Unidad"
//           </Typography>
//         </Box>
//       );
//     }
...
//             <strong>{detalleCalculo.productos.length}</strong>
//           </Typography>
...
//             </Typography>
//             <Box
//               sx={{ ml: 2, p: 1, backgroundColor: "#fff3e0", borderRadius: 1 }}
//             >
//               {detalleCalculo.productos.map((prod, idx) => (
//                 <Typography key={idx} variant="caption" display="block">
//                   - {prod.descripcion}: cantidad: 1, porcDescuento:{" "}
//                   {prod.esMenor ? "100%" : "0%"}
//                 </Typography>
//               ))}
//               <Typography
...
//               <strong>{detalleCalculo.productoMenor}</strong>
//             </Typography>
//             <Typography variant="body2">
//               • Descuento por unidad:{" "}
//               <strong>${detalleCalculo.descuentoPorUnidad}</strong>
